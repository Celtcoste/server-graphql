...
import (
	...
	"gitlab.com/fendcer-company/common/golang-modules/server-graphql/src/handlers"
	"gitlab.com/fendcer-company/common/golang-modules/server-graphql/src/health"
	"gitlab.com/fendcer-company/common/golang-modules/server-graphql/src/logging"
	"gitlab.com/fendcer-company/common/golang-modules/server-graphql/src/middleware"
	"gitlab.com/fendcer-company/common/golang-modules/server-graphql/src/postgresql"
